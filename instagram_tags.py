...
def get_instagram_tags(tag, redlist, blocked_words, num_of_tags = 30):
    ...
    redlist = str(redlist).split(',')
    blocked_words = str(blocked_words).split(',')
    ...
    num_of_tags = is_int(num_of_tags)
    html = None
    html_string = ""
    num_photos = 0
    out = ".\n.\n.\n.\n.\n.\n.\n.\n.\n.\n"
    ...
    print(percentages)
    log.close()
    return {"hashtags":out, "stats":percentages, "err":err}